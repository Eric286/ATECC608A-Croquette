...
about: Report a bug or unexpected behavior while using the ATECC608A-Croquette  Board.
...
Any feedback/suggestions should be discussed on the [feedback section](https://github.com/ElectronicCats/ATECC608A-Croquette/issues):
